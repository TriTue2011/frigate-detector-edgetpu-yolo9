...
***Official [Frigate](https://github.com/blakeblackshear/frigate) version 0.17 added support to run YOLO v9 models on Google Coral device.*** The [pull request to add YOLO v9 support to the main Frigate repository](https://github.com/blakeblackshear/frigate/pull/21124) was accepted on December 2 2025. Since then, there is no need to use this code.
